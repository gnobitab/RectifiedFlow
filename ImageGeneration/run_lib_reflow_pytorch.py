...
def train(config, workdir):
  ...
  ckpt_dir = '/scratch/cluster/xcliu/ODE_Diffusion/logs_cifar/cifar10_mixup_gaussian_dropout_015_ema_999999/checkpoints/checkpoint_8.pth'
  ...
  if config.training.sde.lower() == 'vpsde':
    ...
    sde = sde_lib.MIXUP(init_type=config.sampling.init_type, noise_scale=config.sampling.init_noise_scale, N=config.model.num_scales, rematching=True, use_ode_sampler=config.sampling.use_ode_sampler, target_model=ema_score_model)
    sampling_eps = 1e-3
  else:
